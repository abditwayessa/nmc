...
if($sql)
{
echo "<script>alert('Lab technician information added Successfully');</script>";
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Register New Lab Technician</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										...
										<div class="col-lg-8 col-md-12">
											<div class="panel panel-white">
												<div class="panel-heading">
													<h5 class="panel-title" style="margin-left: 270px;">Fill new lab technician information</h5>
												</div>
...
<div class="form-group">
					...
					<input type="text" style="margin-left: 200px;" name="fname" class="col-sm-5"  placeholder="Enter lab technician's first name" required="true">
														</div><br><br>
...
<div class="form-group">
					...
					<input type="text" style="margin-left: 200px;" name="lname" class="col-sm-5"  placeholder="Enter lab technician's last name" required="true">
														</div><br><br>
<div class="form-group">
															<label for="fess" style="margin-left: 200px;">
																 Age
															</label>
					<input type="text" style="margin-left: 200px;" name="age" class="col-sm-5"  placeholder="Enter lab technician's age" required="true">
														</div><br><br>
	<div class="form-group">
