...
if($sql)
{
$msg="Radiologist's details updated successfully";
...
<html lang="en">
	<head>
		<title>Admin  | Edit Radiologist's Details</title>
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Edit Radiologist's Details</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
									...
									<li class="active">
										<span>Edit Radiologist Details</span>
									</li>
								</ol>
							</div>
						</section>
										...
										<div class="col-lg-8 col-md-12">
											<div class="panel panel-white">
												<div class="panel-heading">
													<h5 class="panel-title" style="margin-left: 240px;">Edit Radiologist's info</h5>
												</div>
...
<div class="form-group">
					...
					<input type="text" name="regDate" style="margin-left: 200px;" class="col-sm-5" readonly="readonly" value="<?php echo htmlentities($data['regDate']);?>"><br><br><br>
														</div>
														...
														<center>
														<button type="submit" name="submit" class="btn btn-green btn-primary" style="margin-left: 200px;">
															Update
...
<div class="panel panel-green" >
	<img src="images/images-5.jpg" style="height: 589px;width: 650px;">
</div>			
</div>
