...
$sql=mysqli_query($con,"Update employee set fname='$firstName',lname='$lastName',age='$age',gender='$gender',address='$address', tele='$tele', updationDate='$updationDate' where id='$did'");
if($sql)
{
$msg=$firstName."'s details updated successfully";
...
<html lang="en">
	<head>
		<title>Admin |  Edit Clerk's Details</title>
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Edit Clerk's Details</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
									...
									<li>
										<span>View Clerk Information</span>
									</li>
									<li class="active">
										<span>Edit Clerk's Details</span>
									</li>
								</ol>
							</div>
						</section>
										...
										<div class="col-lg-8 col-md-12">
											<div class="panel panel-white">
												<div class="panel-heading">
													<h5 class="panel-title" style="margin-left: 200px;">Edit Clerk's Information</h5>
												</div>
...
?>
<center>
<h4><?php echo htmlentities($data['fname']);?>'s Information</h4>
<p><b>Information Reg. Date: </b><?php echo htmlentities($data['regDate']);?></p>
<?php if($data['updationDate']){?>
<p><b>Information Last Updation Date: </b><?php echo htmlentities($data['updationDate']);?></p>
<?php } ?>
</center>
<hr />
...
<div class="form-group">
	...
	<input type="text" style="margin-left: 200px;" name="firstName" class="col-sm-5" value="<?php echo htmlentities($data['fname']);?>" required="required">
														</div>
...
<div class="form-group">
					...
					<input type="text" style="margin-left: 200px;" name="lastName" class="col-sm-5"  value="<?php echo htmlentities($data['lname']);?>" required="required">
														</div>
<div class="form-group">
															<label for="fess" style="margin-left: 200px;">
																 Age
															</label>
		<input type="text"  name="age" style="margin-left: 200px;" class="col-sm-5" required="required"  value="<?php echo htmlentities($data['age']);?>" >
														</div>
	<br>
...
<div class="form-group">
					...
					<input type="text" style="margin-left: 200px;" name="regDate" class="col-sm-5" readonly="readonly" value="<?php echo htmlentities($data['regDate']);?>">
														...
														<center><br><br>
														<button style="margin-left: 200px;" type="submit" name="submit" class="btn btn-green btn-primary">
															Update
														</button>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
														<button type="reset" name="clear" class="btn btn-red btn-primary">
															Clear
														</button>
													</center>
													</form>
...
<div class="panel panel-green" >
	<img src="images/images-4.jpg" style="height: 589px;width: 650px;">
</div>
</div>
