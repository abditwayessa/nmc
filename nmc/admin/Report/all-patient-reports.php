...
<div class="row">
<div class="col-md-12">
<h4 class="tittle-w3-agileits mb-4">Total Patient: <?php echo '<u>'.$count.'</u>';  ?></h4>
...
<center>
<a href="all-pat-doc.php"><button type="button" class="btn btn-green"><i class="fa fa-download"></i> Download as Word </button></a>&emsp;&emsp;&emsp;
<a href="all-pat-exc.php"><button type="button" class="btn btn-red"><i class="fa fa-download"></i> Download as Excel </button></a></center>
