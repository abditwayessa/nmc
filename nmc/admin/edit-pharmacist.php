...
if($sql)
{
$msg="Pharmacist's Details updated Successfully";
}
}
?>
<!DOCTYPE html>
<html lang="en">
	<head>
		<title>Admin | Edit Pharmacist's Details</title>
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Edit Pharmacist's Details</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
									...
									<li>
										<span> View Pharmacist Information</span>
									</li>
									<li class="active">
										<span>Edit Pharmacist's Details</span>
									</li>
								</ol>
							</div>
						</section>
										...
										<div class="col-lg-8 col-md-12">
											<div class="panel panel-white">
												<div class="panel-heading">
													<h5 class="panel-title" style="margin-left: 240px;">Edit Pharmacist's info</h5>
												</div>
