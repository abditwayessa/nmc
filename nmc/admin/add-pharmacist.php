...
if($sql)
{
echo "<script>alert('Pharmacist information added Successfully');</script>";
...
<html lang="en">
	<head>
		<title>Admin | Register Pharmacist</title>
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Register New Pharmacist</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										...
										<div class="col-lg-8 col-md-12">
											<div class="panel panel-white">
												<div class="panel-heading">
													<h5 class="panel-title" style="margin-left: 270px;">Fill new Pharmacist information</h5>
												</div>
...
<div class="form-group">
					...
					<input type="text" style="margin-left: 200px;" name="fname" class="col-sm-5"  placeholder="Enter pharmacist's first name" required="true">
														</div><br><br>
...
<div class="form-group">
					...
					<input type="text" style="margin-left: 200px;" name="lname" class="col-sm-5"  placeholder="Enter pharmacist's last name" required="true"></textarea>
														</div><br><br>
<div class="form-group">
															<label for="fess" style="margin-left: 200px;">
																 Age
															</label><br>
					<input type="text" style="margin-left: 200px;" name="age" class="col-sm-5"  placeholder="Enter pharmacist's age" required="true">
														</div><br><br>
	<div class="form-group">
...
<input type="text" style="margin-left: 200px;" id="docemail" name="tele" class="col-sm-5"  placeholder="Enter telephone number" required="true">
		...
		<button type="submit" style="margin-left: 140px;" name="submit" id="submit" class="btn btn-green btn-primary">Register</button>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
