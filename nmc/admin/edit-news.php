...
<form action="" class="form-horizontal" id="form_sample_1" method="post" enctype="multipart/form-data">
		...
		$posted=mysqli_query($con, "UPDATE news SET title='$title', content='$content', update_date='$update_date' WHERE id='$news_id'");
						if ($posted) {
							echo '<div class="alert alert-dismissable alert-success" style="margin-top:-20px;">';
							echo '<strong>'.'<center>'."News updated successfully! ".'</center>'.'<strong>';
							echo '</div>';
						} else{
							echo '<div class="alert alert-dismissable alert-fail" style="margin-top:-20px;">';
							echo '<strong>'.'<center>'."News not updated!".'</center>'.'<strong>';
							echo '</div>';
								}
																	...
																	<?php
																	$id = $_GET['id'];
																		$news = mysqli_query($con,"SELECT * FROM news WHERE id='$id'");
                                           ...
                                           <div class="form-group form-md-line-input">
                                            ...
                                            <div class="form-group form-md-line-input">
                                                ...
                                                <div class="col-md-9">
                                                    <textarea class="wysihtml5 form-control" rows="6" name="content" id="content" data-error-container="#editor1_error" required><?php echo $row['content'];  ?></textarea>
                                                    <div class="form-control-focus"> </div>
                                                </div>
                                            </div>
																						<div class="form-group form-md-line-input">
																								<label class="col-md-3 control-label" for="form_control_1">Posted Date
																										<span class="required">*</span>
																								</label>
																								<div class="col-md-9">
																									  <input type="text" class="form-control" value="<?php echo $row['post_date'];} ?>" name="date" id="date" readonly>
																										<div class="form-control-focus"> </div>
																								</div>
																						</div>
                                            <button type="submit" class="btn green" name="post_news" id="post_news" >Update</button>&nbsp;&nbsp;&nbsp;
