...
<div class="row">
<div class="col-sm-8">
<h1 class="mainTitle">Radioscopy Request</h1>
</div>
<ol class="breadcrumb">
<li>
...
<div class="row">
<div class="col-md-12">
<h5 class="over-title margin-bottom-15">List of <span class="text-bold">Radioscopy request</span></h5>
...
<?php
$rid=$_SESSION['userid'];
$sql=mysqli_query($con,"SELECT * FROM xultrareport WHERE status=1");
$cnt=1;
...
<td>
<a href="add-xultra.php?cardno=<?php echo $row['cardNo'];?>">Response</a>
</td>
</tr>
<?php 
$cnt=$cnt+1;
