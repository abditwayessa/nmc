				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Lab Technician | Change Password</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
					...
					<input type="password" style="margin-left: 200px;" name="npass" class="col-sm-5"  placeholder="Enter New Password">
														</div><br><br>
...
<div class="form-group">
									...
									<input type="password" style="margin-left: 200px;" name="cfpass" class="col-sm-5"  placeholder="Enter Confirm Password">
														</div><br><br>
														
														<button type="submit" style="margin-left: 200px;" name="submit" class="btn btn-green" id="submit">
															Change
