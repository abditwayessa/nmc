...
<html lang="en">
	<head>
		<title>Laboratory | Laboratory Request</title>
...
<div class="row">
<div class="col-sm-8">
<h1 class="mainTitle">Laboratory Request</h1>
</div>
<ol class="breadcrumb">
<li>
...
<div class="row">
<div class="col-md-12">
<h5 class="over-title margin-bottom-15">List of <span class="text-bold">Laboratory request</span></h5>
...
<tbody>
<?php
$sql=mysqli_query($con,"SELECT * FROM labreport WHERE status=1");
$cnt=1;
...
<td>
<a href="add-lab.php?cardno=<?php echo $row['cardNo'];?>">Submit Result</a>
</td>
</tr>
<?php 
$cnt=$cnt+1;
