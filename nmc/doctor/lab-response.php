...
<html lang="en">
	<head>
		<title>Doctor | Laboratory Report</title>
...
<div class="row">
<div class="col-sm-8">
<h1 class="mainTitle">Laboratory Report</h1>
</div>
<ol class="breadcrumb">
<li>
...
<div class="row">
<div class="col-md-12">
<h5 class="over-title margin-bottom-15"><center> <span class="text-bold">List of Laboratory Report </center></span></h5>
	<hr/>
