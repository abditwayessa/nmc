				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Doctor | Home</h1>
									<div align="right">
									 </div>
								</div>
								<ol class="breadcrumb">
	 ...
	 $counts=$counts+1;} ?>
											<p class="cl-effect-1">
												<a href="notification.php">
													<?php if($counts!=0){ ?>
													You have <?php echo '<span style="color:red; font-weight:bolder;">'.$counts.'</span>'; ?> notification
												<?php } else{ ?>
													Doctor no notification <?php } ?>
												</a>
											</p>
										</div>
									</div>
								...
								<div class="col-sm-4">
									<div class="panel panel-white no-radius text-center">
										<div class="panel-body">
											<span class="fa-stack fa-2x"> <i class="fa fa-square fa-stack-2x text-primary"></i> <i class="fa fa-filter fa-stack-1x fa-inverse"></i> </span>
											<h2 class="StepTitle">Laboratory</h2>
								...
								<div class="col-sm-4">
									<div class="panel panel-white no-radius text-center">
										<div class="panel-body">
											<span class="fa-stack fa-2x"> <i class="fa fa-square fa-stack-2x text-primary"></i> <i class="fa fa-plug fa-stack-1x fa-inverse"></i> </span>
											<h2 class="StepTitle">Radioscopy</h2>
										
											<p class="cl-effect-1">
												<a href="xray-response.php">
													View Radioscopy Report
												</a>
											</p>
										</div>
									</div>
...
while ($row=mysqli_fetch_array($nots)) {
	 $counts=$counts+1;} ?>
													<?php if($counts!=0){ ?>
													You have <?php echo '<span style="color:red; font-weight:bolder;">'.$counts.'</span>'; ?> appointment!
												<?php } else{ ?>
													There is no appointment! <?php } ?>
												</a>
											</p>
										</div>
									</div>
