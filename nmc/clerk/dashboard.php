				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Clerk | Home</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Clerk</span>
						...
						<!-- start: BASIC EXAMPLE -->
							...
							<div class="row">
								...
								<div class="col-sm-4">
									<div class="panel panel-white no-radius text-center">
										<div class="panel-body">
											<span class="fa-stack fa-2x"> <i class="fa fa-square fa-stack-2x text-primary"></i> <i class="fa fa-meh-o fa-stack-1x fa-inverse"></i> </span>
								...
								<div class="col-sm-4">
									<div class="panel panel-white no-radius text-center">
										<div class="panel-body">
											...
											<h2 class="StepTitle">Specialization</h2>
										
											<p class="cl-effect-1">
												<a href="manage-specialization.php">
