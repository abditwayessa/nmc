				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Pharmacist | Home </h1>
																	</div>
								<ol class="breadcrumb">
									<li>
								...
								<div class="col-sm-4">
									<div class="panel panel-white no-radius text-center">
										<div class="panel-body">
											...
											<h2 class="StepTitle">Received Prescreption</h2>
										
											<p class="cl-effect-1">
												<a href="pres-request.php">
													View Received Prescreption
												</a>
											</p>
										</div>
									</div>
								...
								<div class="col-sm-4">
									<div class="panel panel-white no-radius text-center">
										<div class="panel-body">
											...
											<h2 class="StepTitle">Admitted Medication</h2>
										
											<p class="cl-effect-1">
												<a href="med-response.php">
													View Admitted Medication
												</a>
											</p>
										</div>
									</div>
